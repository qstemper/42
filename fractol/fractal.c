...
int	mandelbrot(t_env *e, t_frac fractal, t_point *pt)
{
				...
				&& (fractal.ite < fractal.ite_max))
	{
		...
		fractal.z.r = fractal.z.r * fractal.z.r - fractal.z.im * fractal.z.im + fractal.c.r;
...
int	b_ship(t_env *e, t_frac fractal, t_point *pt)
{
				...
				&& (fractal.ite < fractal.ite_max))
	{
		fractal.tmp = fractal.z.r;
		fractal.z.r = fractal.z.r * fractal.z.r - fractal.z.im * fractal.z.im + fractal.c.r;
		fractal.z.im = 2 * fabs(fractal.z.im) * fabs(fractal.tmp) + fractal.c.im;
		fractal.ite += 1;
	}
	if (fractal.ite == fractal.ite_max)
		return (rgb_creating(fractal.ite * 255 / fractal.ite_max, 10 , 0));
	return (rgb_creating(fractal.ite * 255 / fractal.ite_max, fractal.ite * 255 / (fractal.ite_max * 2), 0));
}
